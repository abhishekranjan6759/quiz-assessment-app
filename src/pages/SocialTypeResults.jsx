...
import { categorizeSocialType } from '../utils/categories';

function SocialTypeResults() {
  ...
  answers.forEach((answer) => {
    const category = categorizeSocialType(answer);
    if (category) {
      categories[category]++;
    }
  });
...
export default SocialTypeResults;