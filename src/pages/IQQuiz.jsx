...
function IQQuiz() {
  ...
  const handleNext = () => {
    if (currentQuestion < iqQuestions.length - 1) {
      ...
      navigate('/results/iq', { state: { answers, userName } });
    }
  };
  ...
  return (
    <div className="app-container">
      <div className="quiz-container">
        <QuizProgress current={currentQuestion} total={iqQuestions.length} />
        <div className="quiz-body">
          <div className="question-section">
            ...
            <div className="quiz-navigation">
              ...
              >
                {currentQuestion === iqQuestions.length - 1 ? 'Submit' : 'Next'}
              </button>
            </div>
          </div>
        </div>
